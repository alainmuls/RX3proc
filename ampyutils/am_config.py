...
def createLoggers(baseName: str, logLevels: str = ['INFO', 'DEBUG']) -> Tuple[logging.Logger, str]:
    """
...
def get_title_info(logger: logging.Logger) -> Tuple[str, str]:
    ...
    logger.info('{func:s}: dInfo =\n{json!s}'.format(func=cFuncName, json=json.dumps(dInfo, sort_keys=False, indent=4, default=amutils.json_convertor)))
